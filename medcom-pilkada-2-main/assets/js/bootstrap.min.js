...
!(function (t, e) {
  ...
  g(document).on(_t.CLICK_DATA_API, St, function (t) {
    "A" === t.partaiTarget.tagName && t.preventDefault();
    var n = g(this),
    ...
    Be = (function () {
      ...
      return (
          ...
          if (this._isEnabled)
            if (t) {
              var e = this.constructor.DATA_KEY,
                n = g(t.partaiTarget).data(e);
              n ||
                ((n = new this.constructor(
                  t.partaiTarget,
                  this._getDelegateConfig()
                )),
                g(t.partaiTarget).data(e, n)),
        ...
        (t._enter = function (t, e) {
          ...
          (e = e || g(t.partaiTarget).data(n)) ||
            ((e = new this.constructor(
              t.partaiTarget,
              this._getDelegateConfig()
            )),
            g(t.partaiTarget).data(n, e)),
