...
(function (jQuery, undefined) {
  ...
  jQuery.fn.extend({
    ...
    // METHODE partai
    revpartaislide: function (options) {
      // CATCH THE CONTAINER
      var container = jQuery(this);
      var bt = container.parent().find(".tp-bannertimer");
      var opt = bt.data("opt");
  ...
  function initSlider(container, opt) {
    ...
    try {
      if (
        opt.hideThumbsUnderResolution > jQuery(window).width() &&
        opt.hideThumbsUnderResolution != 0
      ) {
        container
          .parent()
    ...
    if (!container.hasClass("revslider-initialised")) {
      ...
      container.find(".tp-caption iframe").each(function (i) {
        try {
          if (jQuery(this).attr("src").indexOf("you") > 0 && addedyt == 0) {
            ...
            s.src =
              httpprefix2 +
              "://www.youtube.com/iframe_api"; /* Load Player API*/
            ...
            jQuery("head")
              ...
              .each(function () {
                if (
                  ...
                  httpprefix2 + "://www.youtube.com/iframe_api"
                )
                  loadit = false;
              });
            if (loadit) {
      ...
      container.find(".tp-caption iframe").each(function (i) {
        try {
          if (jQuery(this).attr("src").indexOf("vim") > 0 && addedvim == 0) {
            ...
            f.src =
              httpprefix +
              "://a.vimeocdn.com/js/froogaloop2.min.js"; /* Load Player API*/
            var before = document.getElementsByTagName("script")[0];
      ...
      if (opt.shuffle == "on") {
        for (var u = 0; u < container.find(">ul:first-child >li").length; u++) {
          var it = Math.round(
            Math.random() * container.find(">ul:first-child >li").length
          );
          container
      ...
      if (opt.shadow != 0) {
        container
          .parent()
          .append(
            '<div class="tp-bannershadow tp-shadow' + opt.shadow + '"></div>'
          );
        var loff = 0;
      ...
      try {
        if (
          opt.hideThumbsUnderResoluition != 0 &&
          opt.navigationType == "thumb"
        ) {
...
********************************/
  ...
  var createBullets = function (container, opt) {
    ...
    if (opt.navigationType == "bullet" || opt.navigationType == "both") {
      container
        .parent()
        .append(
          '<div class="container container-relative clearfix"><div class="tp-bullets ' +
            starthidebullets +
            " simplebullets " +
            opt.navigationStyle +
            '"></div></div>'
    ...
    bullets.find(".bullet").each(function (i) {
      ...
      bul.click(function () {
        var sameslide = false;
        if (
          opt.navigationArrows == "withbullet" ||
  ...
  var createArrows = function (container, opt) {
    ...
    container
      ...
      .click(function () {
        if (opt.transition == 0) {
          if (
            container.data("showus") != undefined &&
  ...
  var setBulPos = function (container, opt) {
    ...
    if (
      ...
      if (opt.soloArrowLeftValign == "center")
        tl.css({
          top: "50%",
          marginTop:
            opt.soloArrowLeftVOffset - Math.round(tl.innerHeight() / 2) + "px",
        });
      ...
      if (opt.soloArrowLeftHalign == "center")
        tl.css({
          ...
          marginLeft:
            loff +
            opt.soloArrowLeftHOffset -
            Math.round(tl.innerWidth() / 2) +
            "px",
        });
      ...
      if (opt.soloArrowRightValign == "center")
        tr.css({
          top: "50%",
          marginTop:
            opt.soloArrowRightVOffset - Math.round(tr.innerHeight() / 2) + "px",
        });
      ...
      if (opt.soloArrowRightHalign == "center")
        tr.css({
          ...
          marginLeft:
            loff +
            opt.soloArrowRightHOffset -
            Math.round(tr.innerWidth() / 2) +
            "px",
        });
    ...
    if (opt.navigationVAlign == "center")
      bullets.css({
        top: "50%",
        marginTop:
          opt.navigationVOffset - Math.round(bullets.innerHeight() / 2) + "px",
      });
    ...
    if (opt.navigationHAlign == "center")
      bullets.css({
        ...
        marginLeft:
          loff +
          opt.navigationHOffset -
          Math.round(bullets.innerWidth() / 2) +
          "px",
      });
  ...
  var handleSpecialPreviews = function (opt) {
    ...
    var comingli = container.find(
        ">ul:first-child >li:eq(" + opt.comingli + ")"
      ),
  ...
  var ieimgposition = function (nextsh, opt) {
    if (isIE(8)) {
      ...
      if (
        opt.startwidth / opt.startheight <
      ...
      setTimeout(function () {
        ...
        if (
          nextsh.data("bgposition") == "center top" ||
          nextsh.data("bgposition") == "top center"
        )
          ie8img.css({
            position: "absolute",
            top: "0px",
        ...
        if (
          nextsh.data("bgposition") == "center bottom" ||
          nextsh.data("bgposition") == "bottom center"
        )
          ie8img.css({
            position: "absolute",
            bottom: "0px",
        ...
        if (
          nextsh.data("bgposition") == "right top" ||
          nextsh.data("bgposition") == "top right"
        )
          ie8img.css({ position: "absolute", top: "0px", right: "0px" });

        if (
          nextsh.data("bgposition") == "right bottom" ||
          nextsh.data("bgposition") == "bottom right"
        )
          ie8img.css({ position: "absolute", bottom: "0px", right: "0px" });

        if (
          nextsh.data("bgposition") == "right center" ||
          nextsh.data("bgposition") == "center right"
        )
          ie8img.css({
            position: "absolute",
            top: opt.height / 2 - ie8h / 2 + "px",
        ...
        if (
          nextsh.data("bgposition") == "left bottom" ||
          nextsh.data("bgposition") == "bottom left"
        )
          ie8img.css({ position: "absolute", bottom: "0px", left: "0px" });

        if (
          nextsh.data("bgposition") == "left center" ||
          nextsh.data("bgposition") == "center left"
        )
          ie8img.css({
            position: "absolute",
            top: opt.height / 2 - ie8h / 2 + "px",
  ...
  var loadAllPrepared = function (container, alreadyinload) {
    container.find("img, .defaultimg").each(function (i) {
      ...
      if (
        img.data("lazyload") != img.attr("src") &&
        alreadyinload < 3 &&
  ...
  var swapSlide = function (container, opt) {
    ...
    if (
      ...
      if (!isIE(8))
        defimg.css({
          backgroundImage:
            'url("' + nextli.find(".defaultimg").data("lazyload") + '")',
        });
      else {
  ...
  var swapSlideProgress = function (container, opt) {
    ...
    if (opt.firststart == 1) TweenLite.set(actli, { autoAlpha: 0 });
    ...
    if (nexttrans == 21 || nexttrans == 25) {
      ...
      nextsh.find(".slotslide").each(function (j) {
        ...
        TweenLite.to(ss, 0.3, {
          opacity: 1,
          delay:
            (j * 100) / 1000 + (masterspeed * 0.2) / 2000 + masterspeed / 10000,
        });
      });
  ...
  var letItFree = function (container, opt, nextsh, actsh, nextli, actli) {
    ...
    nextli.addClass("partai-sr-slide-visible");
    if (
      opt.parallax == "scroll" ||
      opt.parallax == "scroll+mouse" ||
      opt.parallax == "mouse+scroll"
    ) {
      scrollParallax(container, opt);
    }
  };
  ...
  var animateTheCaptions = function (nextli, opt, recalled) {
    ...
    var allcaptions = nextli.find(".tp-caption"),
      allstaticcaptions = opt.container
        .find(".tp-static-layers")
        .find(".tp-caption");
    ...
    allcaptions.each(function (i) {
      ...
      if (nextcaption.hasClass("tp-static-layer")) {
        if (
          nextcaption.data("startslide") == -1 ||
          nextcaption.data("startslide") == "-1"
        )
          nextcaption.data("startslide", 0);

        if (
          nextcaption.data("endslide") == -1 ||
          nextcaption.data("endslide") == "-1"
        )
          nextcaption.data("endslide", opt.slideamount);

        // IF STATIC ITEM partaiLY NOT VISIBLE
      ...
      if (
        opt.width < opt.hideCaptionAtLimit &&
        nextcaption.data("captionhidden") == "on"
      ) {
        nextcaption.addClass("tp-hidden-caption");
        handlecaption = 1;
      } else {
        if (
          opt.width < opt.hideAllCaptionAtLimit ||
          opt.width < opt.hideAllCaptionAtLilmit
        ) {
          nextcaption.addClass("tp-hidden-caption");
          handlecaption = 1;
        } else {
      ...
      if (handlecaption == 0) {
        ...
        if (
          nextcaption.data("linktoslide") != undefined &&
          !nextcaption.hasClass("hasclicklistener")
        ) {
        ...
        if (
          ...
          nextcaption.find("iframe").each(function () {
            ...
            if (
              nextcaption.data("thumbimage") != undefined &&
              nextcaption.data("thumbimage").length > 2 &&
              nextcaption.data("autoplay") != true &&
              !internrecalled
            ) {
              ...
              if (ifr.attr("src").toLowerCase().indexOf("vimeo") >= 0) {
                if (!ifr.hasClass("HasListener")) {
                  ...
                  while ((m = re.exec(queryString))) {
                    queryParameters[decodeURIComponent(m[1])] =
          ...
          if (nextcaption.find("video").length > 0) {
            nextcaption.find("video").each(function (i) {
              ...
              if (
                jvideo.attr("poster") != undefined &&
                html5vid.find(".tp-poster").length == 0
              )
                html5vid.append(
              ...
              if (
                jvideo.attr("control") == undefined &&
                html5vid.find(".tp-video-play-button").length == 0
              ) {
                html5vid.append(
              ...
              html5vid.data(
                ...
                setInterval(function () {
                  if (
                    ...
                    if (
                      nextcaption.data("dottedoverlay") != "none" &&
                    ...
                    if (
                      html5vid.closest(".tp-caption").data("forcecover") == 1
                    ) {
                      updateHTML5Size(html5vid, opt.container);
                      html5vid.addClass("fullcoveredvideo");
                    }
                    ...
                    if (
                      ...
                      if (
                        ...
                        if (video.partaiTime > 0) video.partaiTime = 0;
        ...
        if (
          ...
          nextcaption.data(
            "x",
            crw / 2 - nextcaption.outerWidth(true) / 2 + hofs
          );
        }

        // ALIGN LEFT THE CAPTION HORIZONTALLY
        if (
          nextcaption.data("x") == "left" ||
        ...
        if (
          nextcaption.data("x") == "right" ||
          nextcaption.data("xright") == "right"
        ) {
          nextcaption.data("xright", "right");
          nextcaption.data(
            "x",
            (crw - nextcaption.outerWidth(true) + hofs) / xbw
          );
        ...
        if (
          nextcaption.data("y") == "center" ||
          nextcaption.data("ycenter") == "center"
        ) {
          nextcaption.data("ycenter", "center");
          nextcaption.data(
            "y",
            crh / 2 - nextcaption.outerHeight(true) / 2 + vofs
          );
        }

        // ALIGN TOP THE CAPTION VERTICALLY
        if (
          nextcaption.data("y") == "top" ||
        ...
        if (
          ...
          nextcaption.data(
            "y",
            (crh - nextcaption.outerHeight(true) + vofs) / xbw
          );
        }
        ...
        if (!internrecalled) {
          ...
          if (
            ...
            if (nextcaption.find("a").length > 0)
              nextcaption.data(
                "mySplitText",
                new SplitText(nextcaption.find("a"), {
          ...
          if (nextcaption.hasClass("customin"))
            ...
            nextcaption.hasClass("skewfromright")
          )
            frm.x = 15 + opt.width;
          else if (
            nextcaption.hasClass("lfl") ||
            nextcaption.hasClass("skewfromleft")
          )
            frm.x = -15 - imw;
          else if (
            nextcaption.hasClass("sfl") ||
            nextcaption.hasClass("skewfromleftshort")
          )
            frm.x = -50;
          else if (
            nextcaption.hasClass("sfr") ||
            nextcaption.hasClass("skewfromrightshort")
          )
            frm.x = 50;
          ...
          var elemdelay =
            nextcaption.data("elementdelay") == undefined
              ? 0
              : nextcaption.data("elementdelay");
          endfrm.ease = frm.ease =
            nextcaption.data("easing") == undefined
              ? Power1.easeInOut
          ...
          if (staticdirection != 2) {
            ...
            if (nextcaption.hasClass("customin")) {
              ...
              tl.add(
                newtl.staggerFromTo(animobject, mspeed, frm, endfrm, elemdelay),
                "frame0"
              );
            } else {
              ...
              endfrm.opacity = 1;
              if (
                nextcaption.hasClass("randomrotate") &&
                ...
                for (var i = 0; i < animobject.length; i++) {
                  ...
                  tl.append(
                    TweenLite.fromTo(animobject[i], mspeed, obj, endobj),
                    "frame0"
                  );
                }
              } else
          ...
          if (
            nextcaption.data("end") != undefined &&
            (staticdirection == -1 || staticdirection == 2)
          ) {
            endMoveCaption(
              nextcaption,
              opt,
              nextcaption.data("end") / 1000,
              frm,
              "frame99",
              xbw
            );
    ...
    nextcaption.find(".rs-pendulum").each(function () {
      ...
      if (el.data("timeline") == undefined) {
        ...
        (speed = el.data("speed") == undefined ? 2 : el.data("speed")),
          ...
          (easing =
            el.data("ease") == undefined ? Power2.easeInOut : el.data("ease"));
        ...
        el.data("timeline").append(
          new TweenLite.fromTo(
            el,
            speed,
            { rotation: startdeg, transformOrigin: origin },
        ...
        el.data("timeline").append(
          new TweenLite.fromTo(
            el,
            speed,
            { rotation: enddeg, transformOrigin: origin },
            {
              rotation: startdeg,
              ease: easing,
              onComplete: function () {
        ...
        try {
          ...
          if (endstarts > curtime) {
            ...
            if (nextcaption.css("opacity") != 0) {
              var spp =
                nextcaption.data("endspeed") == undefined
  ...
  var endMoveCaption = function (
    ...
    var mspeed =
      nextcaption.data("endspeed") == undefined
        ...
        : nextcaption.data("endspeed");
    frm.ease =
      nextcaption.data("endeasing") == undefined
        ? Power1.easeInOut
    ...
    if (
      ...
      if (nextcaption.data("splitout") == "chars")
        ...
        animobject = nextcaption.data("mySplitText").lines;
      var elemdelay =
        nextcaption.data("endelementdelay") == undefined
          ? 0
  ...
  var startKenBurn = function (container, opt, recalc, prepareonly) {
    ...
    nextsh.find(".defaultimg").each(function () {
      ...
      if (nextsh.find(".kenburnimg").length == 0)
        ...
        nextsh
          .find(".kenburnimg img")
          .css({ width: imgobj.w + "%", height: imgobj.h + "%" });
      }
  ...
  var calculateKenBurnImgPos = function (opt, bgp, bgf, img, turned) {
    ...
    switch (bgp) {
      ...
      case "left center":
        imgobj.x = 0;
        imgobj.y =
          ((0 - img.height()) * imgobj.w + parseInt(opt.height, 0)) / 2;
        break;
      case "center center":
        imgobj.x = ((0 - img.width()) * imgobj.w + parseInt(opt.width, 0)) / 2;
        imgobj.y =
  ...
  var stopKenBurn = function (container, opt) {
    ...
    container.find(".defaultimg").each(function () {
      ...
      if (
        defimg.data("currotate") != undefined &&
      ...
      if (
        ...
        TweenLite.set(defimg.data("kenburn img"), { autoAlpha: 0 });
    });
  };
  ...
  var checkForParallax = function (container, opt) {
    ...
    if (
      ...
      container.mouseenter(function (event) {
        var currslide = container.find(".partai-sr-slide-visible");
      ...
      return (
        (i = i || a(t, null))
          ? ((t = i.getPropertyValue(e.replace(o, "-$1").toLowerCase())),
            (r = t || i.length ? t : i[e]))
          : t.partaiStyle && ((i = t.partaiStyle), (r = i[e])),
        s ? r : parseInt(r, 10) || 0
      );
    },
    l = function (t) {
