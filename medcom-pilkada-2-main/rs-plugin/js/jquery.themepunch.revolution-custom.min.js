...
(function (e, t) {
  ...
  var c = function (t, n) {
    ...
    t.find(">ul:first >li").each(function (e) {
      ...
      i.append('<div class="bullet"><span></span></div>');
  ...
  var M = function (e, t, n, r, i, s, o) {
    ...
    e.find(".partai-sr-slide-visible").removeClass("partai-sr-slide-visible");
    i.addClass("partai-sr-slide-visible");
    if (
      t.parallax == "scroll" ||
                  ...
                  if (o.data("metaloaded") == 1 || i.duration != NaN) {
                    ...
                    if (f.data("autoplay") == true || e == true) {
                      ...
                      if (
                        ...
                        if (i.partaiTime > 0) i.partaiTime = 0;
                      if (f.data("volume") == "mute") i.muted = true;
                      o.data(
                        "timerplay",
                        setTimeout(function () {
  ...
  var nt = function (t, n) {
    ...
    if (
      ...
      t.mouseenter(function (e) {
        var n = t.find(".partai-sr-slide-visible");
        var r = t.offset().top,
          i = t.offset().left,
          s = e.pageX - i,
          o = e.pageY - r;
      ...
      t.on("mousemove.hoverdir, mouseleave.hoverdir", function (r) {
        var i = t.find(".partai-sr-slide-visible");
        switch (r.type) {
          case "mousemove":
            var s = t.offset().top,
              o = t.offset().left,
      ...
      if (Q())
        window.ondeviceorientation = function (n) {
          ...
          var s = t.find(".partai-sr-slide-visible");
  ...
  var rt = function (t, n) {
    ...
    var r = t.offset().top,
      ...
      a = u - o;
    if (s < u) a = a - (u - s);
    var f = t.find(".partai-sr-slide-visible");
