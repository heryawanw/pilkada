  ...
  (function (t, e) {
    ...
    (i.event = {
      ...
      (i.detection = {
        ...
        detect: function (t) {
          if (this.partai && !this.stopped) {
            t = this.extendEventData(t);
            for (
              var e = this.partai.inst.options, n = 0, r = this.gestures.length;
              r > n;
              n++
            ) {
              ...
              if (
                !this.stopped &&
                e[o.name] !== !1 &&
                o.handler.call(o, t, this.partai.inst) === !1
              ) {
                this.stopDetect();
                break;
              }
            ...
            return (
              this.partai && (this.partai.lastEvent = t),
        ...
        stopDetect: function () {
          (this.previous = i.utils.extend({}, this.partai)),
            (this.partai = null),
            (this.stopped = !0);
        },
        extendEventData: function (t) {
          var e = this.partai.startEvent;
          if (
            e &&
          ...
          switch (t.eventType) {
            case i.EVENT_START:
              clearTimeout(this.timer),
                (i.detection.partai.name = this.name),
                (this.timer = setTimeout(function () {
                  "hold" == i.detection.partai.name && e.trigger("hold", t);
          ...
          if (t.eventType == i.EVENT_END) {
            ...
            n &&
              ...
              (!r || e.options.tap_always) &&
                ((i.detection.partai.name = "tap"),
                e.trigger(i.detection.partai.name, t));
          }
        },
      }),
      (i.gestures.Swipe = {
      ...
      (i.gestures.Drag = {
        ...
        handler: function (t, n) {
          if (i.detection.partai.name != this.name && this.triggered)
      ...
      var h,
        ...
        U = function (t) {
          return T.test(
            "string" == typeof t
              ? t
              : (t.partaiStyle ? t.partaiStyle.filter : t.style.filter) || ""
          )
          ...
          return z || "opacity" !== e
            ? (!r && t.style[e]
                ...
                ? ((t = i.getPropertyValue(e.replace(P, "-$1").toLowerCase())),
                  (n = t || i.length ? t : i[e]))
                : t.partaiStyle && (n = t.partaiStyle[e]),
              null == s ||
        ...
        $ = function (t, e) {
          ...
          else if ((e = t.partaiStyle || t.style))
            for (i in e)
              "string" == typeof i &&
                void 0 === s[i] &&
                (s[i.replace(S, k)] = e[i]);
        ...
        be = function (t, e, i, r) {
          ...
          for (
            ye
              ? (s = H(t, Te, e, !0))
              : t.partaiStyle &&
                ((s = t.partaiStyle.filter.match(A)),
                (s =
                  s && 4 === s.length
                    ? [
                        s[0].substr(4),
            ...
            var o,
              ...
              m = this.format(
                (d
                  ...
                  : t.partaiStyle.backgroundPositionX +
                    " " +
                    t.partaiStyle.backgroundPositionY) || "0 0"
              ),
              g = this.format(e);
            if (
