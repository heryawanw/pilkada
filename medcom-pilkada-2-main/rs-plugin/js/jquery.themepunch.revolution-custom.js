        ...
        if (window.tplogs == true)
          try {
            console.groupCollapsed(
              "Slider Revolution 4.5.7 Initialisation on " +
                jQuery(this).attr("id")
            );
  ...
  function initSlider(container, opt) {
    ...
    if (!container.hasClass("revslider-initialised")) {
      ...
      container.find(".tp-caption").each(function (i) {
        ...
        try {
          if (
            (jQuery(this).data("ytid") != undefined ||
              jQuery(this)
                .find("iframe")
                .attr("src")
                .toLowerCase()
        ...
        try {
          if (
            (jQuery(this).data("vimeoid") != undefined ||
              jQuery(this)
                .find("iframe")
                .attr("src")
                .toLowerCase()
        ...
        try {
          if (
            jQuery(this).data("videomp4") != undefined ||
            jQuery(this).data("videowebm") != undefined
          ) {
          }
        } catch (e) {}
      });
...
********************************/
  ...
  // check if partai tab is active or not
  var vis = (function () {
    var stateKey,
      eventKey,
      keys = {
          ...
          switch (direction) {
            ...
            case "down":
              if (aps == "none")
                jQuery("html, body").animate({
                  scrollTop:
                    container.offset().top - jQuery(window).height() + "px",
                });
              break;
          }
        },
  ...
  var animateTheCaptions = function (nextli, opt, recalled, mtl) {
    ...
    allcaptions.each(function (i) {
      ...
      if (handlecaption == 0) {
        ...
        if (
          nextcaption.hasClass("tp-videolayer") ||
          ...
          var frameID = "iframe" + Math.round(Math.random() * 100000 + 1),
            ...
            httpprefix = "http",
            videoloop =
              nextcaption.data("videoloop") == "loop"
                ? "loop"
          ...
          nextcaption.find("iframe").each(function () {
            ...
            if (ifr.attr("src").toLowerCase().indexOf("youtube") >= 0) {
              ...
              if (!ifr.hasClass("HasListener")) {
                ...
                if (
                  (!is_mobile() && nextcaption.data("autoplay") == true) ||
                  autoplaywason
                ) {
                  nextcaption.data(
                    "timerplay",
          ...
          if (is_mobile() && nextcaption.data("disablevideoonmobile") == 1)
            nextcaption.find("video").remove();
          if (is_mobile() && jQuery(window).width() < 569)
            nextcaption.find("video").remove();
            ...
            if (nextcaption.find("a").length > 0)
              ...
              nextcaption.data(
                ...
                new punchgs.SplitText(
                  nextcaption.find(".tp-layer-inner-rotation"),
                  {
                    type: "lines,words,chars",
                    charsClass: "tp-splitted",
                    wordsClass: "tp-splitted",
    ...
    if (
      ...
      container.on("starttimer", function () {
        if (
          ...
          if (
            (opt.stopLoop == "on" && opt.next == opt.lastslidetoshow - 1) ||
            opt.noloopanymore == 1
          ) {
            opt.noloopanymore = 1;
          } else {
