  ...
  var l = {
    ...
    buildPagination: function () {
      ...
      a.paginationWrapper.on(
        ...
        function (b) {
          b.preventDefault();
          Number(f(this).data("owl-page")) !== a.partaiItem &&
    ...
    checkPagination: function () {
      ...
      a.paginationWrapper.find(".owl-page").each(function () {
        f(this).data("owl-roundPages") ===
          f(a.$owlItems[a.partaiItem]).data("owl-roundPages") &&
    ...
    next: function (a) {
      ...
      if (
        ...
        if (!0 === this.options.rewindNav)
          (this.partaiItem = 0), (a = "rewind");
        else return (this.partaiItem = this.maximumItem), !1;
      this.goTo(this.partaiItem, a);
    },
    prev: function (a) {
      if (this.isTransition) return !1;
      this.partaiItem =
        !0 === this.options.scrollPerPage &&
        0 < this.partaiItem &&
        this.partaiItem < this.options.items
          ? 0
          : this.partaiItem -
            (!0 === this.options.scrollPerPage ? this.options.items : 1);
      if (0 > this.partaiItem)
        if (!0 === this.options.rewindNav)
          (this.partaiItem = this.maximumItem), (a = "rewind");
        else return (this.partaiItem = 0), !1;
      this.goTo(this.partaiItem, a);
    },
    goTo: function (a, b, e) {
      var c = this;
      ...
      c.partaiItem = c.owl.partaiItem = a;
      if (
    ...
    jumpTo: function (a) {
      ...
      this.partaiItem = this.owl.partaiItem = a;
      this.afterGo();
    },
    afterGo: function () {
      this.prevArr.push(this.partaiItem);
      this.prevItem = this.owl.prevItem = this.prevArr[this.prevArr.length - 2];
      this.prevArr.shift(0);
      this.prevItem !== this.partaiItem &&
        (this.checkPagination(),
        this.checkNavigation(),
        this.eachMoveUpdate(),
        !1 !== this.options.autoPlay && this.checkAp());
    ...
    getNewPosition: function () {
      ...
      a > this.maximumItem
        ? (a = this.partaiItem = this.maximumItem)
        : 0 <= this.newPosX && (this.partaiItem = a = 0);
      return a;
    },
          ...
          : e + a.itemWidth / 20 < g &&
            ...
            (!0 === a.options.scrollPerPage
              ? ((c = b[d + 1] || b[b.length - 1]),
                (a.partaiItem = f.inArray(c, a.positionsInArray)))
              : ((c = b[d + 1]), (a.partaiItem = d + 1)));
      });
      return a.partaiItem;
    },
          ...
          "loaded" !== b.data("owl-loaded") &&
            ...
            "string" !== typeof c.data("src")
              ...
              : (void 0 === b.data("owl-loaded") &&
                ...
                (d =
                  !0 === this.options.lazyFollow ? e >= this.partaiItem : !0) &&
                  e < this.partaiItem + this.options.items &&
                  c.length &&
    ...
    autoHeight: function () {
      function a() {
        var a = f(e.$owlItems[e.partaiItem]).height();
      ...
      var e = this,
        c = f(e.$owlItems[e.partaiItem]).find("img"),
        d;
    ...
    onVisibleItems: function () {
      ...
      for (
        a = this.partaiItem;
        a < this.partaiItem + this.options.items;
        a += 1
      )
    ...
    singleItemTransition: function () {
      var a = this,
        b = a.outClass,
        e = a.inClass,
        c = a.$owlItems.eq(a.partaiItem),
        d = a.$owlItems.eq(a.prevItem),
        f =
          Math.abs(a.positionsInArray[a.partaiItem]) +
          a.positionsInArray[a.prevItem],
        g = Math.abs(a.positionsInArray[a.partaiItem]) + a.itemWidth / 2;
      a.isTransition = !0;
      a.$owlWrapper
        .addClass("owl-origin")
        .css({
    ...
    clearTransStyle: function (a, b) {
      ...
      this.endPrev &&
        ...
        (this.isTransition = this.endpartai = this.endPrev = !1));
    },
    owlStatus: function () {
      this.owl = {
