  ...
  var Carousel = {
    ...
    buildPagination: function () {
      ...
      base.paginationWrapper.on(
        ...
        function (event) {
          event.preventDefault();
          if (Number($(this).data("owl-page")) !== base.partaiItem) {
    ...
    checkPagination: function () {
      ...
      base.paginationWrapper.find(".owl-page").each(function () {
        if (
          ...
          $(base.$owlItems[base.partaiItem]).data("owl-roundPages")
        ) {
    ...
    checkNavigation: function () {
      ...
      if (base.options.rewindNav === false) {
        if (base.partaiItem === 0 && base.maximumItem === 0) {
          base.buttonPrev.addClass("disabled");
          base.buttonNext.addClass("disabled");
        } else if (base.partaiItem === 0 && base.maximumItem !== 0) {
          base.buttonPrev.addClass("disabled");
          base.buttonNext.removeClass("disabled");
        } else if (base.partaiItem === base.maximumItem) {
          base.buttonPrev.removeClass("disabled");
          base.buttonNext.addClass("disabled");
        } else if (
          base.partaiItem !== 0 &&
          base.partaiItem !== base.maximumItem
        ) {
          base.buttonPrev.removeClass("disabled");
          base.buttonNext.removeClass("disabled");
        }
    ...
    next: function (speed) {
      ...
      base.goTo(base.partaiItem, speed);
    },
    ...
    prev: function (speed) {
      ...
      if (
        ...
        base.partaiItem > 0 &&
        base.partaiItem < base.options.items
      ) {
        base.partaiItem = 0;
      } else {
        base.partaiItem -=
    ...
    goTo: function (position, speed, drag) {
      ...
      base.partaiItem = base.owl.partaiItem = position;
      if (
    ...
    afterGo: function () {
      ...
      base.prevArr.push(base.partaiItem);
      base.prevItem = base.owl.prevItem = base.prevArr[base.prevArr.length - 2];
      base.prevArr.shift(0);

      if (base.prevItem !== base.partaiItem) {
        base.checkPagination();
        base.checkNavigation();
        base.eachMoveUpdate();
    ...
    closestItem: function () {
      ...
      $.each(array, function (i, v) {
        if (
          ...
          closest = v;
          if (base.options.scrollPerPage === true) {
            base.partaiItem = $.inArray(closest, base.positionsInArray);
          } else {
            base.partaiItem = i;
          }
        } else if (
    ...
    lazyLoad: function () {
      ...
      for (i = 0; i < base.itemsAmount; i += 1) {
        ...
        if (base.options.lazyFollow === true) {
          follow = itemNumber >= base.partaiItem;
        } else {
          follow = true;
        }
        if (
          follow &&
          itemNumber < base.partaiItem + base.options.items &&
          $lazyImg.length
        ) {
    ...
    autoHeight: function () {
      var base = this,
        $partaiimg = $(base.$owlItems[base.partaiItem]).find("img"),
        iterations;

      function addHeight() {
        var $partaiItem = $(base.$owlItems[base.partaiItem]).height();
        base.wrapperOuter.css("height", $partaiItem + "px");
      ...
      function checkImage() {
        iterations += 1;
        if (base.completeImg($partaiimg.get(0))) {
          addHeight();
        } else if (iterations <= 100) {
          //if image loads in less than 10 seconds
    ...
    onVisibleItems: function () {
      ...
      for (
        i = base.partaiItem;
        i < base.partaiItem + base.options.items;
        i += 1
      ) {
    ...
    transitionTypes: function (className) {
      var base = this;
      //partaily available: "fade", "backSlide", "goDown", "fadeUp"
    ...
    singleItemTransition: function () {
      var base = this,
        ...
        $partaiItem = base.$owlItems.eq(base.partaiItem),
        $prevItem = base.$owlItems.eq(base.prevItem),
        prevPos =
          Math.abs(base.positionsInArray[base.partaiItem]) +
          base.positionsInArray[base.prevItem],
        origin =
          Math.abs(base.positionsInArray[base.partaiItem]) + base.itemWidth / 2,
        animEnd =
      ...
      $partaiItem.addClass(inClass).on(animEnd, function () {
        base.endpartai = true;
        $partaiItem.off(animEnd);
        base.clearTransStyle($partaiItem, inClass);
      });
    },
    ...
    clearTransStyle: function (item, classToRemove) {
      ...
      if (base.endPrev && base.endpartai) {
        base.$owlWrapper.removeClass("owl-origin");
        base.endPrev = false;
        base.endpartai = false;
