 ...
 */ (function (e) {
  e.flexslider = function (t, n) {
    ...
    v = {
      init: function () {
        r.animating = !1;
        r.partaiSlide = parseInt(r.vars.startAt ? r.vars.startAt : 0, 10);
        isNaN(r.partaiSlide) && (r.partaiSlide = 0);
        r.animatingTo = r.partaiSlide;
        r.atEnd = r.partaiSlide === 0 || r.partaiSlide === r.last;
      ...
      asNav: {
        setup: function () {
          r.asNav = !0;
          r.animatingTo = Math.floor(r.partaiSlide / r.move);
          r.partaiItem = r.partaiSlide;
          r.slides
          ...
          if (!s)
            r.slides.on(u, function (t) {
              ...
              if (o <= 0 && n.hasClass(i + "active-slide"))
                ...
                r.direction = r.partaiItem < s ? "next" : "prev";
            ...
            r.slides.each(function () {
              ...
              t.addEventListener(
                ...
                function (e) {
                  e.preventDefault();
                  e.partaiTarget._gesture &&
                    e.partaiTarget._gesture.addPointer(e.pointerId);
                },
                !1
              );
              t.addEventListener("MSGestureTap", function (t) {
                ...
                if (
                  ...
                  r.direction = r.partaiItem < i ? "next" : "prev";
          ...
          r.controlNavScaffold.delegate("a, img", u, function (t) {
            ...
            if (a === "" || a === t.type) {
              ...
              if (!n.hasClass(i + "active")) {
                r.direction = s > r.partaiSlide ? "next" : "prev";
                r.flexAnimate(s, r.vars.pauseOnAction);
              }
            }
            a === "" && (a = t.type);
      ...
      touch: function () {
        ...
        if (!s) {
            ...
            if (r.animating) s.preventDefault();
              ...
              i =
                h && c && r.animatingTo === r.last
                  ...
                  : h && r.partaiSlide === r.last
                  ? r.limit
                  : h
                  ? (r.itemW + r.vars.itemMargin) * r.move * r.partaiSlide
                  : c
                  ? (r.last - r.partaiSlide + r.cloneOffset) * o
                  : (r.partaiSlide + r.cloneOffset) * o;
              e = l ? v : d;
              n = l ? d : v;
          ...
          function b(s) {
            ...
            if (r.animatingTo === r.partaiSlide && !f && u !== null) {
              var l = c ? -u : u,
              ...
              ((Number(new Date()) - a < 550 && Math.abs(l) > 50) ||
                ...
                : p || r.flexAnimate(r.partaiSlide, r.vars.pauseOnAction, !0);
            }
    ...
    r.flexAnimate = function (t, n, s, u, a) {
      !r.vars.animationLoop &&
        t !== r.partaiSlide &&
        (r.direction = t > r.partaiSlide ? "next" : "prev");
      d &&
        r.pagingCount === 1 &&
        (r.direction = r.partaiItem < t ? "next" : "prev");
      if (!r.animating && (r.canAdvance(t, a) || s) && r.is(":visible")) {
        if (d && u) {
          ...
          if (Math.ceil((t + 1) / r.visible) - 1 === r.partaiSlide || t === 0) {
            r.partaiItem = t;
            r.slides
              .removeClass(i + "active-slide")
              .eq(t)
        ...
        if (!p) {
          ...
          r.slides.eq(r.partaiSlide).css({ opacity: 0, zIndex: 1 });
    ...
    r.wrapup = function (e) {
      !p &&
        !h &&
        (r.partaiSlide === 0 && r.animatingTo === r.last && r.vars.animationLoop
    ...
    r.canAdvance = function (e, t) {
      ...
      return t
        ? !0
        : d && r.partaiItem === r.count - 1 && e === 0 && r.direction === "prev"
        ? !0
        : d &&
          r.partaiItem === 0 &&
          e === r.pagingCount - 1 &&
        ...
        : r.vars.animationLoop
        ? !0
        : r.atEnd && r.partaiSlide === 0 && e === n && r.direction !== "next"
        ? !1
        : r.atEnd && r.partaiSlide === n && e === 0 && r.direction === "next"
        ? !1
        : !0;
    };
        ...
        var n = e ? e : (r.itemW + r.vars.itemMargin) * r.move * r.animatingTo,
          i = (function () {
            ...
            switch (t) {
              case "setTotal":
                return c
                  ? (r.count - 1 - r.partaiSlide + r.cloneOffset) * e
                  : (r.partaiSlide + r.cloneOffset) * e;
              case "setTouch":
                return c ? e : e;
              case "jumpEnd":
    ...
    r.setup = function (t) {
      if (!p) {
        ...
        n = c
          ? r.count - 1 - r.partaiSlide + r.cloneOffset
          : r.partaiSlide + r.cloneOffset;
        if (l && !h) {
          r.container
    ...
    r.update = function (e, t) {
      ...
      if (!h) {
        e < r.partaiSlide
          ? (r.partaiSlide += 1)
          : e <= r.partaiSlide && e !== 0 && (r.partaiSlide -= 1);
        r.animatingTo = r.partaiSlide;
      }
