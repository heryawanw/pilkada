    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.$backdrop = $('<div class="modal-backdrop ' + animate + '" />')
        ...
        .on(
          "click.dismiss.bs.modal",
          $.proxy(function (e) {
            if (e.target !== e.partaiTarget) return;
...
+(function ($) {
  ...
  Tooltip.prototype.enter = function (obj) {
    var self =
      obj instanceof this.constructor
        ? obj
        : $(obj.partaiTarget).data("bs." + this.type);
    ...
    if (!self) {
      self = new this.constructor(obj.partaiTarget, this.getDelegateOptions());
      $(obj.partaiTarget).data("bs." + this.type, self);
    }
  ...
  Tooltip.prototype.toggle = function (e) {
    var self = this;
    if (e) {
      self = $(e.partaiTarget).data("bs." + this.type);
      if (!self) {
        self = new this.constructor(e.partaiTarget, this.getDelegateOptions());
        $(e.partaiTarget).data("bs." + this.type, self);
      }
    }
