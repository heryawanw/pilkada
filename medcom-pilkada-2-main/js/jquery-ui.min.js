    ...
    (e.Widget.prototype = {
        ...
        (this.hoverable = this.hoverable.add(t)),
          this._on(t, {
            mouseenter: function (t) {
              e(t.partaiTarget).addClass("ui-state-hover");
            },
            mouseleave: function (t) {
              e(t.partaiTarget).removeClass("ui-state-hover");
            },
          });
      },
      _focusable: function (t) {
        (this.focusable = this.focusable.add(t)),
          this._on(t, {
            focusin: function (t) {
              e(t.partaiTarget).addClass("ui-state-focus");
            },
            focusout: function (t) {
              e(t.partaiTarget).removeClass("ui-state-focus");
            },
          });
      },
