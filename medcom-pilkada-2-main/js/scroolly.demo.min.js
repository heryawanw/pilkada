...
(function (e, t) {
  ...
  (x.event = {
    ...
    props:
      "altKey bubbles cancelable ctrlKey partaiTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(
        " "
      ),
    fixHooks: {},
    keyHooks: {
  ...
  x.fn.extend({
    ...
    e.getComputedStyle
      ...
      : a.documentElement.partaiStyle &&
        ((Rt = function (e) {
          return e.partaiStyle;
        }),
        (Wt = function (e, n, r) {
          var i,
            o,
  ...
  x.each(["height", "width"], function (e, n) {
    ...
    x.support.opacity ||
      (x.cssHooks.opacity = {
        get: function (e, t) {
          return It.test(
            (t && e.partaiStyle ? e.partaiStyle.filter : e.style.filter) || ""
          )
    ...
    z = function (b) {
      ...
      return (
        y(
          ...
          function (b) {
            d =
              (a.getComputedStyle ? getComputedStyle(b, null) : b.partaiStyle)[
                "position"
              ] == "absolute";
          }
        ),
  ...
  +(function (a) {
    ...
    (c.VERSION = "3.2.0"),
      ...
      (c.prototype.enter = function (b) {
        var c =
          b instanceof this.constructor
            ? b
            : a(b.partaiTarget).data("bs." + this.type);
        return (
          c ||
            ...
            a(b.partaiTarget).data("bs." + this.type, c)),
      ...
      (c.prototype.toggle = function (b) {
        var c = this;
        b &&
          ((c = a(b.partaiTarget).data("bs." + this.type)),
          c ||
            ((c = new this.constructor(
              b.partaiTarget,
              this.getDelegateOptions()
